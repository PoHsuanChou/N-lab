...
void Instrclist(prog* p, stack* s)
{
    if(strsame(p->wds[p->cw],"}")){
        ...
        if(Isinstrc(p)){
            ...
            ERROR("Something wrong with instruction");
        }
    }
...
void Print(prog* p)
{
    if(p->wds[p->cw][0] == '$'){
        if(Varname(p)){
            ...
            ERROR("Soemthing wrong with varname in printf_function");
        }
    }
        ...
        if(String(p)){
            ...
            ERROR("Soemthing wrong with string in printf_function");
        }
        
        
    }
    else{
        ERROR("Something wrong with print_function");
    }
...
{   if(Varname(p)){
        ...
        ERROR("Something wrong with varname in set_function");
    }
...
void Pushdown(prog* p, stack* s)
{
    if(p->wds[p->cw][0] == '$'){
        if(Varname(p)){
            ...
            ERROR("Something wrong with varname in pushdown");
        }
    }
        ...
        if(Integer(p)){
            ...
            ERROR("Something wrong with interger in pushdown");
        }
    }
...
void Create(prog* p,stack* s)
{
    if(strsame(p->wds[p->cw],"ONES")){
        ...
        if(Integer(p)){
            ...
            ERROR("Something wrong with integer_1 in create_functuin");
        }
        if(Integer(p)){
            stack_push(p->wds[p->cw],s);
            p->cw = p ->cw + 1;
            ...
            ERROR("Something wrong with integer_2 in create_functuin");
        }
        ...
        if(Varname(p)){
            ...
            ERROR("something wrong in varname in create function");
        }
    }
    else{
...
void Read(prog* p,stack* s)
{
    if(strsame(p->wds[p->cw],"READ")){
        ...
        if(String(p)){
            ...
            ERROR("something wrong with string in Read function");
        }
        ...
        if(Varname(p)){
            ...
            ERROR("ERROR Something wrong with varname in READ function\n");
        }
...
void Loop(prog* p,stack* s)
{
    if(Varname(p)){
        ...
        ERROR("ERROR Something wrong with varname in loop function\n");
    }
    if(Integer(p)){
        stack_push(p->wds[p->cw],s);
    p->cw = p ->cw + 1;
        ...
        ERROR("ERROR Something wrong with integer in loop function\n");
    }
    if(strsame(p->wds[p->cw],"{")){
        char str1[SIZE];
        char str2[SIZE];
...
bool Varname(prog* p)
{
    ...
    if(p->wds[p->cw][1] >= 'A' || p->wds[p->cw][1] <= 'Z'){
        ...
        ERROR("Something wrong with varname!");
    }
